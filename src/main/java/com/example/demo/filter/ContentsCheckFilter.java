...
@Slf4j
public class ContentsCheckFilter implements ChooseFilter{
	...
	public ContentsCheckFilter(JedisFactory jedisFactory, String contentName) {
		super();
	...
	public void filter(List<Server> serverList) {
		...
		try {
            String jedisResult = jedis.get(contentName);
			List<String> foundServerIds = objectMapper.readValue(jedisResult, List.class);
